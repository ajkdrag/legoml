...
from experiments.image_clf.models import Res2Net_32x32
...
with run(base_dir=Path("runs").joinpath("eval_img_clf_cifar10")) as sess:
    ...
    checkpoint_path = "./runs/train_img_clf_cifar10/run_20250904_102432/artifacts/checkpoints/ckpt_best.pt"
